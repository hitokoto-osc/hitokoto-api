import { compact, curry } from 'lodash-es'

export const enableGracefullyShutdown = () => {
...
const DEFAULT_FORMATTING_PIPELINE = Object.freeze({
  ...
  preFormat: (err: Error) => Object.assign({}, err),
...
const applyFormat = curry((err: Error, acum: , formatter) => formatter(err, acum))
...
export const recoverAB = async function recoverAB() {
