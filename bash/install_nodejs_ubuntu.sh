...
${bold}${NODENAME} is no longer actively supported!${normal}
   ...
   * ${green}https://deb.nodesource.com/setup_4.x 鈥� Node.js v4 LTS \"Argon\"${normal} (recommended)
   * ${green}https://deb.nodesource.com/setup_6.x 鈥� Node.js v6 Current${normal}
...
exec_cmd "echo 'deb https://mirrors.ustc.edu.cn/nodesource/deb/${NODEREPO} ${DISTRO} main' > /etc/apt/sources.list.d/nodesource.list"
exec_cmd "echo 'deb-src https://mirrors.ustc.edu.cn/nodesource/deb/${NODEREPO} ${DISTRO} main' >> /etc/apt/sources.list.d/nodesource.list"
